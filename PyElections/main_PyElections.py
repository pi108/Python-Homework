...
#==========================================================================================================
# This block of logic creates a variable for the CSV File to be read.
#==========================================================================================================
...
# 2. It ensures that rows with unreadable characters will not be skipped by specifying "encoding="utf8". 
# 3. It reads the CSV file into a Dictionary by using csv.DictReader instead of just csv.Reader.
#==========================================================================================================
...
# 5. It craetes a new LIST just with the Percentage of the Total Vote Count (sorted based on Total Vote Count).
...
# When the original zipped combined list was printed, it was no longer available to be used.
# 2. It creates a variable for the output CSV File.
# 3. It reads from the re-zipped combined list and writes to the output CSV file.
#===========================================================================================================
...
with open(output_file, 'w') as datafile:
    ...
    writer.writerow(["",""])
    writer.writerow(["1st Advancing Candidate :", str(my_candidate_name_final_results[0])])
    writer.writerow(["2nd Advancing Candidate :", str(my_candidate_name_final_results[1])])


#===========================================================================================================
# This block of logic does 3 things to write the output to a TXT File:
# 1. It re-zips 3 lists into the combined list. 
# When the original zipped combined list was printed, it was no longer available to be used.
# 2. It creates a variable for the output TXT File.
# 3. It reads from the re-zipped combined list and writes to the output TXT file.
#===========================================================================================================
...
with open(output_file, "w") as datafile:
    ...
    datafile.write("--------------------------------------------------------")
    datafile.write("\n")  
    datafile.write("1st Advancing Candidate  :  " + str(my_candidate_name_final_results[0]))
    datafile.write("\n") 
    datafile.write("2nd Advancing Candidate  :  " + str(my_candidate_name_final_results[1]))
    datafile.write("\n") 
    datafile.write("--------------------------------------------------------")
    datafile.write("\n") 
